...
func Test_keyExpansion_128bit(t *testing.T) {
    ...
    checkWord("keyExp", word{b: [4]byte{0x2b, 0x7e, 0x15, 0x16}}, ekey[0], t)
    checkWord("keyExp", word{b: [4]byte{0x28, 0xae, 0xd2, 0xa6}}, ekey[1], t)
    checkWord("keyExp", word{b: [4]byte{0xab, 0xf7, 0x15, 0x88}}, ekey[2], t)
    checkWord("keyExp", word{b: [4]byte{0x09, 0xcf, 0x4f, 0x3c}}, ekey[3], t)
    checkWord("keyExp", word{b: [4]byte{0xa0, 0xfa, 0xfe, 0x17}}, ekey[4], t)
    checkWord("keyExp", word{b: [4]byte{0x88, 0x54, 0x2c, 0xb1}}, ekey[5], t)
    checkWord("keyExp", word{b: [4]byte{0x23, 0xa3, 0x39, 0x39}}, ekey[6], t)
    checkWord("keyExp", word{b: [4]byte{0x2a, 0x6c, 0x76, 0x05}}, ekey[7], t)
    checkWord("keyExp", word{b: [4]byte{0xf2, 0xc2, 0x95, 0xf2}}, ekey[8], t)
    checkWord("keyExp", word{b: [4]byte{0x7a, 0x96, 0xb9, 0x43}}, ekey[9], t)
    checkWord("keyExp", word{b: [4]byte{0x59, 0x35, 0x80, 0x7a}}, ekey[10], t)
    checkWord("keyExp", word{b: [4]byte{0x73, 0x59, 0xf6, 0x7f}}, ekey[11], t)
    checkWord("keyExp", word{b: [4]byte{0x3d, 0x80, 0x47, 0x7d}}, ekey[12], t)
    checkWord("keyExp", word{b: [4]byte{0x47, 0x16, 0xfe, 0x3e}}, ekey[13], t)
    checkWord("keyExp", word{b: [4]byte{0x1e, 0x23, 0x7e, 0x44}}, ekey[14], t)
    checkWord("keyExp", word{b: [4]byte{0x6d, 0x7a, 0x88, 0x3b}}, ekey[15], t)
    checkWord("keyExp", word{b: [4]byte{0xef, 0x44, 0xa5, 0x41}}, ekey[16], t)
    checkWord("keyExp", word{b: [4]byte{0xa8, 0x52, 0x5b, 0x7f}}, ekey[17], t)
    checkWord("keyExp", word{b: [4]byte{0xb6, 0x71, 0x25, 0x3b}}, ekey[18], t)
    checkWord("keyExp", word{b: [4]byte{0xdb, 0x0b, 0xad, 0x00}}, ekey[19], t)
    checkWord("keyExp", word{b: [4]byte{0xd4, 0xd1, 0xc6, 0xf8}}, ekey[20], t)
    checkWord("keyExp", word{b: [4]byte{0x7c, 0x83, 0x9d, 0x87}}, ekey[21], t)
    checkWord("keyExp", word{b: [4]byte{0xca, 0xf2, 0xb8, 0xbc}}, ekey[22], t)
    checkWord("keyExp", word{b: [4]byte{0x11, 0xf9, 0x15, 0xbc}}, ekey[23], t)
    checkWord("keyExp", word{b: [4]byte{0x6d, 0x88, 0xa3, 0x7a}}, ekey[24], t)
    checkWord("keyExp", word{b: [4]byte{0x11, 0x0b, 0x3e, 0xfd}}, ekey[25], t)
    checkWord("keyExp", word{b: [4]byte{0xdb, 0xf9, 0x86, 0x41}}, ekey[26], t)
    checkWord("keyExp", word{b: [4]byte{0xca, 0x00, 0x93, 0xfd}}, ekey[27], t)
    checkWord("keyExp", word{b: [4]byte{0x4e, 0x54, 0xf7, 0x0e}}, ekey[28], t)
    checkWord("keyExp", word{b: [4]byte{0x5f, 0x5f, 0xc9, 0xf3}}, ekey[29], t)
    checkWord("keyExp", word{b: [4]byte{0x84, 0xa6, 0x4f, 0xb2}}, ekey[30], t)
    checkWord("keyExp", word{b: [4]byte{0x4e, 0xa6, 0xdc, 0x4f}}, ekey[31], t)
    checkWord("keyExp", word{b: [4]byte{0xea, 0xd2, 0x73, 0x21}}, ekey[32], t)
    checkWord("keyExp", word{b: [4]byte{0xb5, 0x8d, 0xba, 0xd2}}, ekey[33], t)
    checkWord("keyExp", word{b: [4]byte{0x31, 0x2b, 0xf5, 0x60}}, ekey[34], t)
    checkWord("keyExp", word{b: [4]byte{0x7f, 0x8d, 0x29, 0x2f}}, ekey[35], t)
    checkWord("keyExp", word{b: [4]byte{0xac, 0x77, 0x66, 0xf3}}, ekey[36], t)
    checkWord("keyExp", word{b: [4]byte{0x19, 0xfa, 0xdc, 0x21}}, ekey[37], t)
    checkWord("keyExp", word{b: [4]byte{0x28, 0xd1, 0x29, 0x41}}, ekey[38], t)
    checkWord("keyExp", word{b: [4]byte{0x57, 0x5c, 0x00, 0x6e}}, ekey[39], t)
    checkWord("keyExp", word{b: [4]byte{0xd0, 0x14, 0xf9, 0xa8}}, ekey[40], t)
    checkWord("keyExp", word{b: [4]byte{0xc9, 0xee, 0x25, 0x89}}, ekey[41], t)
    checkWord("keyExp", word{b: [4]byte{0xe1, 0x3f, 0x0c, 0xc8}}, ekey[42], t)
    checkWord("keyExp", word{b: [4]byte{0xb6, 0x63, 0x0c, 0xa6}}, ekey[43], t)
}
...
func Test_keyExpansion_196bit(t *testing.T) {
    ...
    checkWord("keyExp", word{b: [4]byte{0x8e, 0x73, 0xb0, 0xf7}}, ekey[0], t)
    checkWord("keyExp", word{b: [4]byte{0xda, 0x0e, 0x64, 0x52}}, ekey[1], t)
    checkWord("keyExp", word{b: [4]byte{0xc8, 0x10, 0xf3, 0x2b}}, ekey[2], t)
    checkWord("keyExp", word{b: [4]byte{0x80, 0x90, 0x79, 0xe5}}, ekey[3], t)
    checkWord("keyExp", word{b: [4]byte{0x62, 0xf8, 0xea, 0xd2}}, ekey[4], t)
    checkWord("keyExp", word{b: [4]byte{0x52, 0x2c, 0x6b, 0x7b}}, ekey[5], t)
}
...
func Test_keyExpansion_256bit(t *testing.T) {
    ...
    checkWord("keyExp", word{b: [4]byte{0x60, 0x3d, 0xeb, 0x10}}, ekey[0], t)
    checkWord("keyExp", word{b: [4]byte{0x15, 0xca, 0x71, 0xbe}}, ekey[1], t)
    checkWord("keyExp", word{b: [4]byte{0x2b, 0x73, 0xae, 0xf0}}, ekey[2], t)
    checkWord("keyExp", word{b: [4]byte{0x85, 0x7d, 0x77, 0x81}}, ekey[3], t)
    checkWord("keyExp", word{b: [4]byte{0x1f, 0x35, 0x2c, 0x07}}, ekey[4], t)
    checkWord("keyExp", word{b: [4]byte{0x3b, 0x61, 0x08, 0xd7}}, ekey[5], t)
    checkWord("keyExp", word{b: [4]byte{0x2d, 0x98, 0x10, 0xa3}}, ekey[6], t)
    checkWord("keyExp", word{b: [4]byte{0x09, 0x14, 0xdf, 0xf4}}, ekey[7], t)
}

func Test_subBytes(t *testing.T) {
    s := state{
        b: [4][4]byte{[4]byte{0x19, 0xa0, 0x9a, 0xe9},
...
func Test_invSubBytes(t *testing.T) {
    s := state{
        b: [4][4]byte{[4]byte{0xd4, 0xe0, 0xb8, 0x1e},
...
func Test_shiftRows(t *testing.T) {
    s := state{
        b: [4][4]byte{[4]byte{0x52, 0x85, 0xe3, 0xf6},
...
func Test_mixColumns(t *testing.T) {
    s := state{
        b: [4][4]byte{[4]byte{0xf7, 0x27, 0x9b, 0x54},
...
func Test_invMixColumnsState(t *testing.T) {
    s := state{
        b: [4][4]byte{[4]byte{0x14, 0x46, 0x27, 0x34},
...
func Test_addRoundKey(t *testing.T) {
    s := state{
        b: [4][4]byte{[4]byte{0x32, 0x88, 0x31, 0xe0},
